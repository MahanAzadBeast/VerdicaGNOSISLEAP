"""
Model 2 CANCER-ONLY TRAINING - NO WANDB VERSION
Restart without WandB dependency that was causing authentication issues
"""
...
# FIXED: Proper Modal image without WandB
image = (
...
app = modal.App("model2-cancer-only-restart")
...
def train_cancer_only_model():
    ...
    print("🧬 GNOSIS MODEL 2: CANCER-ONLY TRAINING (RESTARTED)")
    print("=" * 80)
