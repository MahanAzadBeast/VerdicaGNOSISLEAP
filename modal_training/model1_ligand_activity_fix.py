"""
Model 1 LIGAND ACTIVITY PREDICTOR - QUICK FIX
Fixed WandB issue and parameter grouping, same proven architecture
"""
...
# Fixed Modal image without WandB, using proven versions
image = (
...
app = modal.App("model1-ligand-activity-fix")
...
def train_model1_ligand_activity():
    """Train Model 1 with epoch-by-epoch checkpointing (NO WANDB)"""
    
    print("🧬 GNOSIS MODEL 1: LIGAND ACTIVITY PREDICTOR (FIXED)")
    print("=" * 80)
    ...
    # FIXED: Proper parameter grouping using named parameters (same as Model 2 fix)
    ...
    print(f"\n🏋️ STEP 7: TRAINING (Target: R² > 0.6, Previous: 0.5994)...")
...
if __name__ == "__main__":
    with app.run():
        result = train_model1_ligand_activity.remote()
